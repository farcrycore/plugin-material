	...
	<div class="menu-scroll">
		<div class="menu-wrap">
			<div class="menu-content">
				...
				<ul class="nav">
					<li>
						<a href="/material/ui-button.html"><span class="icon icon-dialpad"></span>Buttons</a>
					</li>
					<li>
						<a href="/material/ui-form.html"><span class="icon icon-border-color"></span>Form Elements</a>
					</li>
					<li>
