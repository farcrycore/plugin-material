...
<cfcomponent extends="farcry.core.packages.formtools.boolean" name="mdSwitch" displayname="MD Switch" hint="Field component to liase with boolean field types."> 
			...
			<cfoutput>
				<div class="checkbox switch">
					<label for="#arguments.fieldname#">
						<input class="access-hide" type="checkbox" name="#arguments.fieldname#" id="#arguments.fieldname#" value="1" <cfif arguments.stMetadata.value EQ 1>checked</cfif>><span class="switch-toggle switch-toggle-default-red switch-toggle-green "></span>
